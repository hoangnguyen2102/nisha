                        ...
                        <div class="table-responsive">
                            <table class="table datatable">
                                ...
                                <tr>
                                    ...
                                    <th width="15%">@lang('label.Cycle')</th>
                                    <th width="15%">@lang('label.Price')</th>
                                    <th width="15%">@lang('label.Date register')</th>
                                    <th width="15%">@lang('label.Date start')</th>
                                    <th width="15%">@lang('label.Date end')</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach ($data as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{ $value->cycle }} @lang('label.Month')</td>
                                        <td>{{ convertPrice(config('core.cycle') * $value->cycle) }}</td>
