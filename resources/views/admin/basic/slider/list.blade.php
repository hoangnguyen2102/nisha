                        ...
                        <div class="table-responsive">
                            <table class="table datatable">
                                ...
                                <tr>
                                    ...
                                    <th width="25%">@lang('label.Image')</th>
                                    <th width="25%">@lang('label.Link')</th>
                                ...
                                @foreach ($data as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('storage/'.$value->path_image) }}" class="admin-list-href-image">
                                                <img src="{{ asset('storage/'.$value->path_image) }}" alt="" class="admin-list-image">
                                            </a>
                                        </td>
                                        <td>{{ $value->link }}</td>
